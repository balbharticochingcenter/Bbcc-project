...
function shouldAutoBlock(student) {
    ...
    // Get current and previous month fees
    ...
    // If previous month is unpaid and current month is also unpaid -> block
    if (prevMonthFee && prevMonthFee.status === 'unpaid' && 
        currentMonthFee && currentMonthFee.status === 'unpaid') {
