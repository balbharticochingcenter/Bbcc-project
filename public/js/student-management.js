...
// NO INLINE EVENT HANDLERS - ALL EVENT LISTENERS IN JS
...
(function() {
    ...
    const styles = `
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .modal-content { background: white; border-radius: 20px; max-width: 600px; width: 90%; max-height: 90vh; overflow-y: auto; animation: slideIn 0.3s ease; }
    ...
    // ============================================
    // HTML TEMPLATE - NO INLINE EVENT HANDLERS
    // ============================================
    const htmlTemplate = `
    ...
    // ============================================
    // MAIN APP CLASS - NO INLINE EVENT HANDLERS
    // ============================================
    class StudentManagementSystem {
        ...
        async editStudent(studentId) {
            ...
            document.getElementById('photo').value = student.photo || 'https://via.placeholder.com/100';
