...
// वॉयस इंजन (Human Female Voice)
function talk(text) {
    window.speechSynthesis.cancel();
    let utterance = new SpeechSynthesisUtterance(text);
    let voices = window.speechSynthesis.getVoices();
    let femaleVoice = voices.find(v => v.lang.includes('hi') && (v.name.includes('Google') || v.name.includes('Female')));
    if (femaleVoice) utterance.voice = femaleVoice;
    utterance.pitch = 1.1;
    utterance.rate = 0.85; // थोड़ा और धीरे ताकि स्टेप्स समझ आएँ
    window.speechSynthesis.speak(utterance);
}

// मास्टर डेटाबेस (Keyword Mapping + Steps)
const aiBrain = {
    // --- SYSTEM CONTROL ---
    "admin_id": {
        "keywords": ["id", "admin id", "user id", "पहचान", "आईडी"],
        "ask": "क्या आप एडमिन लॉगिन आईडी बदलने का तरीका जानना चाहते हैं?",
        "steps": "एडमिन आईडी बदलने के लिए: सबसे पहले एडमिन डैशबोर्ड के 'System Control' में 'Admin Profile' पर क्लिक करें। वहां 'Admin Profile Settings' का फॉर्म खुलेगा। दूसरे बॉक्स में 'Login ID' लिखा होगा, उसे हटाकर अपनी पसंद की नई आईडी डालें और नीचे 'Update Admin Profile' बटन पर क्लिक करें। बस हो गया!"
    },
    "password": {
        "keywords": ["password", "pass", "lock", "पासवर्ड", "पासवड"],
        "ask": "क्या आप एडमिन डैशबोर्ड का लॉगिन पासवर्ड बदलना चाहते हैं?",
        "steps": "पासवर्ड बदलने के लिए: 'Admin Profile' बटन दबाएं। फॉर्म में 'Password' वाले बॉक्स में अपना नया पासवर्ड लिखें। उसके नीचे 'Confirm Password' में दोबारा वही पासवर्ड लिखें। अंत में 'Update' बटन दबाएं। अगली बार आप नए पासवर्ड से लॉगिन कर पाएंगे।"
    },
    "coaching_name": {
        "keywords": ["name", "coaching name", "title", "नाम", "कोचिंग"],
        "ask": "क्या आप कोचिंग का नाम या टाइटल बदलना चाहते हैं?",
        "steps": "कोचिंग का नाम बदलने के लिए: 'System Settings' पर क्लिक करें। यहाँ सबसे ऊपर 'Coaching Name' का बॉक्स दिखेगा। नया नाम टाइप करें और सबसे नीचे जाकर 'Update Settings' बटन दबाएं। वेबसाइट पर नाम बदल जाएगा।"
    },

    // --- TEACHER MANAGEMENT ---
    "teacher_add": {
        "keywords": ["teacher add", "new teacher", "टीचर", "शिक्षक"],
        "ask": "क्या आप नया टीचर रजिस्टर करने का तरीका जानना चाहते हैं?",
        "steps": "नया टीचर जोड़ने के लिए: 'Teacher Management' सेक्शन में 'Teacher Reg' बटन पर क्लिक करें। टीचर का नाम, विषय, मोबाइल और सैलरी भरें। याद रखें, टीचर की फोटो लगाने से पहले उसे 'Image Tool' से 'Compress' जरूर कर लें ताकि डैशबोर्ड स्लो न हो।"
    },
    "teacher_salary": {
        "keywords": ["salary", "pay", "vetan", "सैलरी", "वेतन"],
        "ask": "क्या आप टीचर की सैलरी का रिकॉर्ड चेक करना चाहते हैं?",
        "steps": "सैलरी देखने के लिए: 'Teacher Management' में 'Salary/Data' बटन दबाएं। यहाँ आपको सभी शिक्षकों की लिस्ट मिलेगी। जिस टीचर की सैलरी देखनी हो, उसके नाम के आगे 'View' पर क्लिक करें।"
    },

    // --- STUDENT MANAGEMENT ---
    "student_fees": {
        "keywords": ["fees", "paisa", "fee", "payment", "फीस", "पैसा", "शुल्क"],
        "ask": "क्या आप छात्र की फीस जमा करने या रसीद निकालने का स्टेप जानना चाहते हैं?",
        "steps": "फीस जमा करने के लिए: 'Student Management' में 'Fees/Data' पर जाएं। अपनी क्लास चुनें। अब उस छात्र को खोजें जिसकी फीस जमा करनी है। उसके नाम के आगे 'Collect Fees' बटन दबाएं, अमाउंट भरें और रसीद प्रिंट कर लें।"
    },
    "student_reg": {
        "keywords": ["admission", "student reg", "new student", "छात्र", "एडमिशन"],
        "ask": "क्या आप नए छात्र का एडमिशन (रजिस्ट्रेशन) करना चाहते हैं?",
        "steps": "नया एडमिशन करने के लिए: 'Student Reg' बटन पर क्लिक करें। फॉर्म में छात्र की पूरी जानकारी भरें। 'Image' वाले कॉलम में छात्र की फोटो अपलोड करें (फोटो कंप्रेस करना न भूलें)। फॉर्म सबमिट करते ही छात्र को एक रोल नंबर मिल जाएगा।"
    },

    // --- IMAGE TOOLS (Most Important) ---
    "photo_compress": {
        "keywords": ["photo", "compress", "image", "upload", "size", "फोटो", "इमेज"],
        "ask": "क्या आप फोटो अपलोड करने से पहले कंप्रेस करने का सही तरीका जानना चाहते हैं?",
        "steps": "ध्यान दें! फोटो अपलोड से पहले कंप्रेस करना बहुत जरूरी है। स्टेप्स: 1. डैशबोर्ड में सबसे ऊपर 'Image Tool' बॉक्स में जाएं। 2. अपनी फोटो चुनें। 3. 'AS PHOTO' बटन पर क्लिक करें। 4. प्रोसेस होने के बाद फोटो डाउनलोड करें। अब इसी डाउनलोड की गई फोटो को वेबसाइट पर लगाएं, इससे आपकी वेबसाइट बहुत फ़ास्ट चलेगी।"
    }
};

// चैट में मैसेज दिखाना
...
function userSend() {
    ...
    if (foundKey) {
        ...
        let error = "माफ़ कीजिये, मैं समझ नहीं पाई। क्या आप एडमिन आईडी, फीस, टीचर सैलरी या फोटो कंप्रेस के बारे में जानना चाहते हैं? अधिक जानकारी के लिए डेवलपर को कॉल करें: " + devCall;
...
function resetMenu() {
    document.getElementById('questions-list').innerHTML = `
        <button class="q-btn" onclick="openGrp('system')">⚙️ System Help</button>
        <button class="q-btn" onclick="openGrp('teacher')">👨‍🏫 Teacher Help</button>
        <button class="q-btn" onclick="openGrp('student')">🎓 Student Help</button>
    `;
}

// कैटेगरी ग्रुप्स खोलना
function openGrp(g) {
    const groups = {
...
function toggleChat() {
    ...
    if(isOpening) talk("नमस्ते एडमिन, मैं आपकी कैसे मदद कर सकती हूँ? कृपया फोटो अपलोड से पहले कंप्रेस जरूर करें।");
}
