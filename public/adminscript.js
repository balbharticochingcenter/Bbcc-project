...
const aiBrain = {
    "admin_id": {
        "keywords": ["id", "admin id", "user id", "आईडी", "login id"],
        "ask": "क्या आप एडमिन लॉगिन आईडी बदलने का तरीका जानना चाहते हैं?",
        "steps": "एडमिन आईडी बदलने के लिए: सबसे पहले एडमिन डैशबोर्ड के 'System Control' में 'Admin Profile' पर क्लिक करें। वहां 'Admin Profile Settings' का फॉर्म खुलेगा। दूसरे बॉक्स में 'Login ID' लिखा होगा, उसे हटाकर अपनी पसंद की नई आईडी डालें और नीचे 'Update Admin Profile' बटन पर क्लिक करें।"
    },
    "password": {
        "keywords": ["password", "pass", "पासवर्ड", "लॉगिन"],
        "ask": "क्या आप एडमिन डैशबोर्ड का लॉगिन पासवर्ड बदलना चाहते हैं?",
        "steps": "पासवर्ड बदलने के लिए: 'Admin Profile' बटन दबाएं। वहां 'Password' वाले बॉक्स में अपना नया पासवर्ड लिखें। उसके ठीक नीचे 'Confirm Password' में दोबारा वही पासवर्ड लिखें। अंत में 'Update' बटन दबाएं। अगली बार नए पासवर्ड से लॉगिन करें।"
    },
    "coaching_name": {
        "keywords": ["name", "coaching", "title", "नाम"],
        "ask": "क्या आप कोचिंग का नाम या टाइटल बदलना चाहते हैं?",
        "steps": "नाम बदलने के लिए: 'System Settings' पर क्लिक करें। सबसे ऊपर 'Coaching Name' का बॉक्स दिखेगा, उसमें नया नाम भरें और सबसे नीचे 'Update Settings' बटन दबा दें।"
    },
    "teacher_add": {
        "keywords": ["teacher add", "new teacher", "टीचर", "शिक्षक"],
        "ask": "क्या आप नया टीचर रजिस्टर करने का तरीका जानना चाहते हैं?",
        "steps": "नया टीचर जोड़ने के लिए: 'Teacher Management' में 'Teacher Reg' पर क्लिक करें। सारी जानकारी भरें। फोटो लगाने से पहले उसे 'Image Tool' से कंप्रेस जरूर कर लें ताकि डैशबोर्ड स्लो न हो।"
    },
    "teacher_salary": {
        "keywords": ["salary", "pay", "वेतन", "सैलरी"],
        "ask": "क्या आप टीचर की सैलरी का रिकॉर्ड चेक करना चाहते हैं?",
        "steps": "सैलरी देखने के लिए: 'Teacher Management' में 'Salary/Data' बटन दबाएं। यहाँ शिक्षकों की लिस्ट मिलेगी, जिसके नाम के आगे 'View' करेंगे उसकी सैलरी दिख जाएगी।"
    },
    "student_fees": {
        "keywords": ["fees", "paisa", "fee", "फीस", "पैसा"],
        "ask": "क्या आप छात्र की फीस जमा करने या रसीद निकालने का स्टेप जानना चाहते हैं?",
        "steps": "फीस के लिए: 'Student Management' में 'Fees/Data' पर जाएं। क्लास चुनें, छात्र के नाम के आगे 'Collect Fees' बटन दबाएं, पैसा भरें और रसीद प्रिंट कर लें।"
    },
    "student_reg": {
        "keywords": ["admission", "student reg", "छात्र", "एडमिशन"],
        "ask": "क्या आप नए छात्र का रजिस्ट्रेशन करना चाहते हैं?",
        "steps": "एडमिशन के लिए: 'Student Reg' बटन पर क्लिक करें। छात्र की जानकारी और फोटो भरें। फोटो कंप्रेस जरूर करें। फॉर्म सबमिट करते ही रोल नंबर मिल जाएगा।"
    },
    "photo_compress": {
        "keywords": ["photo", "compress", "image", "इमेज", "फोटो"],
        "ask": "क्या आप फोटो कंप्रेस करने का सही तरीका जानना चाहते हैं?",
        "steps": "फोटो कंप्रेस करना बहुत जरूरी है! स्टेप्स: 1. सबसे ऊपर 'Image Tool' में जाएं। 2. फोटो चुनें। 3. 'AS PHOTO' बटन दबाएं। 4. डाउनलोड करें। अब यही फोटो अपलोड करें, वेबसाइट बहुत फ़ास्ट चलेगी।"
    }
};
